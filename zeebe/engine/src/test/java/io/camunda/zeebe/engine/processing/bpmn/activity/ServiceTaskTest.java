...
public class ServiceTaskTest {
  ...
  @Test
  public void shouldCompleteJobWithLinkedResources() throws JsonProcessingException {
    ...
    Assertions.assertThat(jobCreated.getValue())
        .hasCustomHeaders(
            Map.of(
                "linkedResources", MAPPER.writeValueAsString(Lists.newArrayList(resourceProps))));
  }
}
