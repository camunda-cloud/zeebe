...
public interface JobClient {
   ...
   *
   * <p>Command to create a batch of documents. This command allows you to create multiple documents
   * in a single request. This can be more efficient than creating each document individually,
   * however, there are multiple limitations to consider. <br>
   * <br>
